...
HD_PWD='/home/richard/Vivado/practica6/practica6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_LUT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_LUT.tcl
