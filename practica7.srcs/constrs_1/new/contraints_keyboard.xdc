...
## Clock signal
#set_property PACKAGE_PIN W5 [get_ports PS2CLK]                                                    
#        set_property IOSTANDARD LVCMOS33 [get_ports PS2CLK]
#        create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports PS2CLK]
...
## LEDs
set_property PACKAGE_PIN U16 [get_ports {scancode[0]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[0]}]
set_property PACKAGE_PIN E19 [get_ports {scancode[1]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[1]}]
set_property PACKAGE_PIN U19 [get_ports {scancode[2]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[2]}]
set_property PACKAGE_PIN V19 [get_ports {scancode[3]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[3]}]
set_property PACKAGE_PIN W18 [get_ports {scancode[4]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[4]}]
set_property PACKAGE_PIN U15 [get_ports {scancode[5]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[5]}]
set_property PACKAGE_PIN U14 [get_ports {scancode[6]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[6]}]
set_property PACKAGE_PIN V14 [get_ports {scancode[7]}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {scancode[7]}]
...
#set_property PACKAGE_PIN P1 [get_ports {test}]                                      
#        set_property IOSTANDARD LVCMOS33 [get_ports {test}]
set_property PACKAGE_PIN L1 [get_ports {key_depressed}]                                      
        set_property IOSTANDARD LVCMOS33 [get_ports {key_depressed}]
...
#set_property PACKAGE_PIN W19 [get_ports bwe]                                          
#        set_property IOSTANDARD LVCMOS33 [get_ports bwe]
